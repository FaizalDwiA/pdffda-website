...
export default function MergePanel({ notify, setLoader, downloadBlob, formatBytes, generateId, onBack }) {
  ...
  return (
    <section id="panel-merge" className="tab-panel space-y-6">
      ...
      <div className="flex items-center space-x-3 pb-2">
        ...
        <span className="text-orange-400 text-xs font-bold font-mono uppercase tracking-wider">Gabung PDF</span>
      </div>
